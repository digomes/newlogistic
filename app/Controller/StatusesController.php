 ...
 */
	public function add() {
		if ($this->request->is('post')) {
			$this->Status->create();
                        $this->request->data['Status']['visibility_groups'] = $this->Status->encodeData($this->request->data['Group']['Group']);
			if ($this->Status->save($this->request->data)) {
                ...
                $groups = $this->Status->Reverse->User->Group->find('list');
 ...
 */
	public function edit($id = null) {
		...
		if ($this->request->is(array('post', 'put'))) {
			...
			$data = $this->Status->read(null, $id);
			$data['Group']['Group'] = $this->Status->decodeData($data['Status']['visibility_groups']);
