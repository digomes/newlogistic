<div class="row-fluid">
   <div class="span12">
	...
	<tr>
		...
		<td><?php echo h($this->Time->format('d/m/Y H:i:s', $reverse['Reverse']['created']
)); ?>&nbsp;</td>
		<td class="actions">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="#"><?php echo $this->Html->link(__('Cancelar Coleta'), array('controller' => 'reverses' ,'action' => 'cancell', $reverse['Reverse']['id'])); ?></a></li>
                        <li><a href="#"><?php echo $this->Html->link(__('Sinistro'), array('controller' => 'reverses' ,'action' => 'sinister', $reverse['Reverse']['id'])); ?></a></li>
                        <li><a href="#"><?php echo $this->Html->link(__('Ocorrência'), array('controller' => 'reverses' ,'action' => 'occurrence', $reverse['Reverse']['id'])); ?></a></li>
                        	<?php } ?>
                   </ul>
                </div>
