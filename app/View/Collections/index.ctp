<div class="collections index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('netprice'); ?></th>
			<th><?php echo $this->Paginator->sort('icms'); ?></th>
			<th><?php echo $this->Paginator->sort('ipi'); ?></th>
	...
	<tr>
		...
		<td>
			<?php echo h($collection['Collection']['workshop']); ?>
		</td>
		<td><?php echo h($collection['Collection']['order']); ?>&nbsp;</td>
		...
		<td><?php echo h($collection['Collection']['netprice']); ?>&nbsp;</td>
		<td><?php echo h($collection['Collection']['icms']); ?>&nbsp;</td>
		<td><?php echo h($collection['Collection']['ipi']); ?>&nbsp;</td>
		<td><?php echo h($collection['Collection']['total']); ?>&nbsp;</td>
		<td class="actions">
